            ...
            <form method="post" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="role" class="form-control"
                        ...
                        value="<?php echo $UpdateDate['role_name'] ?? ''; ?>" required>
                </div>

                <div class="col-md-4 d-flex align-items-end">
                    <?php if ($UpdateDate) : ?>
                        <button type="submit" name="update" class="me-2 btn btn-primary">Update</button>
                        <a href="role.php" class="btn btn-danger">Cancel</a>
                    <?php else : ?>
                        <button type="submit" name="save" class="btn btn-primary">Add Role</button>
                    <?php endif; ?>
                </div>
